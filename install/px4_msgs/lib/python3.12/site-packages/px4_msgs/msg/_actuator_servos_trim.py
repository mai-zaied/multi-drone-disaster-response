    ...
    def trim(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'trim' field must be a set or sequence with length 15 and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
