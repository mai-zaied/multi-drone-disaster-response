...
bool cdr_serialize_px4_msgs__msg__TargetGnss(
  const px4_msgs__msg__TargetGnss * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
bool cdr_deserialize_px4_msgs__msg__TargetGnss(
  eprosima::fastcdr::Cdr & cdr,
  px4_msgs__msg__TargetGnss * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
bool cdr_serialize_key_px4_msgs__msg__TargetGnss(
  const px4_msgs__msg__TargetGnss * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t get_serialized_size_key_px4_msgs__msg__TargetGnss(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TargetGnss__ros_msg_type * ros_message = static_cast<const _TargetGnss__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs
size_t max_serialized_size_key_px4_msgs__msg__TargetGnss(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4_msgs__msg__TargetGnss * ros_message = static_cast<const px4_msgs__msg__TargetGnss *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4_msgs__msg__TargetGnss(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4_msgs__msg__TargetGnss * ros_message = static_cast<px4_msgs__msg__TargetGnss *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4_msgs__msg__TargetGnss(cdr, ros_message);
}
